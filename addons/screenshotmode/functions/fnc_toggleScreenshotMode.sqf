...
*
* Example:
*  [] call lambs_screenshotmode_fnc_toggleScreenshotMode
*
* Public: Yes
*/
...
if (isNil QGVAR(screenshotState)) then {
    GVAR(screenshotState) = [
        ...
        missionNamespace getVariable ["STUI_Canvas_ShownHUD", {false}],
        shownHUD
    ];
    ...
    missionNamespace setVariable ["STUI_Canvas_ShownHUD", {false}];
    ...
    missionNamespace setVariable ["STUI_Canvas_ShownHUD", GVAR(screenshotState) deleteAt 0];
